...
var RuleDatas = []RuleData{
	...
	{"Grafana", "code", "(<title>Grafana</title>|grafana-app|window.grafanaBootData|/public/build/grafana)"},
	{"Grafana", "headers", "(X-Grafana)"},
	{"Prometheus", "code", "(Prometheus Time Series Collection and Processing Server|<title>Prometheus Time Series|prometheus_build_info)"},
	{"Apache APISIX", "code", "(<title>Apache APISIX Dashboard</title>|apisix-dashboard|/apisix/admin/user/login)"},
	{"Apollo", "code", "(Apollo配置中心|apollo-configservice|<title>Apollo|/signin\\?error)"},
	{"Argo Workflows", "code", "(<title>Argo Workflows</title>|argo-ui|workflows.argoproj.io)"},
	...
	{"xxl-job", "code", "(分布式任务调度平台XXL-JOB|XXL-JOB|/xxl-job-admin)"},
	...
	{"Next.js", "code", "(__NEXT_DATA__|/_next/static/|next-head-count|self\\.__next_f)"},
	{"Next.js", "headers", "(X-Nextjs-|X-Powered-By:? ?Next\\.js|NEXT_LOCALE=|X-Middleware-)"},
	{"React", "code", "(data-reactroot|react-dom|react-refresh|__REACT_DEVTOOLS_GLOBAL_HOOK__|self\\.__next_f)"},
	{"React RSC", "code", "(self\\.__next_f|text/x-component|react\\.server|react\\.suspense)"},
	{"Vite", "code", "(/@vite/client|vite/client|import\\.meta\\.hot|vite.svg)"},
	{"Webpack Dev Server", "code", "(webpack-dev-server|webpackHotUpdate|__webpack_dev_server__)"},
	{"Node.js Inspector", "code", "(webSocketDebuggerUrl|node\\.js/v[0-9]+\\.|Protocol-Version)"},
	{"Node.js", "headers", "(X-Powered-By:? ?(Express|Next\\.js|NestJS|Koa))"},
	...
	{"Metabase", "code", "(<title>Metabase</title>|app-main.*metabase|metabase-enterprise)"},
	{"SonarQube", "code", "(<title>SonarQube</title>|sonarqube|SonarSource)"},
	{"MinIO", "code", "(<title>MinIO Console</title>|minio.browser|MinIO Console)"},
	...
	{"WordPress", "code", "(/wp-login.php?action=lostpassword|WordPress</title>|/wp-content/|/wp-includes/|content=\"WordPress|<generator>https?://wordpress.org|wp-emoji-release.min.js)"},
